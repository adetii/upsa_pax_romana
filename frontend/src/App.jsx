...
import Adminentry from './pages/admin/AdminLogin.jsx'
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={<PublicLayout />}> 
          ...
          {/* Payment routes with public layout */}
          <Route path="payment/success" element={<PaymentSuccess />} />
          <Route path="payment/failed" element={<PaymentFailed />} />
        </Route>
        
        {/* Auth routes without layout */}
        <Route path="/admin/entry_255081" element={<Adminentry />} />
        <Route path="/admin/fg-pw_255081" element={<ForgotPassword />} />
        <Route path="/admin/set-pw_255081" element={<ResetPassword />} />
