    ...
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-blue-50">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
            <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-blue-50 to-indigo-50 rounded-full -mr-16 -mt-16 opacity-50"></div>
          ...
          <div className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
            <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-purple-50 to-pink-50 rounded-full -mr-16 -mt-16 opacity-50"></div>
            <div className="relative">
          ...
          <div className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
            <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-indigo-50 to-blue-50 rounded-full -mr-16 -mt-16 opacity-50"></div>
            <div className="relative">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-linear-to-br from-white to-blue-50 rounded-3xl p-8 shadow-lg border border-blue-100">
            <div className="flex items-start gap-4 mb-6">
              <div className="shrink-0 w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">1</div>
              <div>
            ...
            <div className="flex items-start gap-4 mb-6">
              <div className="shrink-0 w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">2</div>
              <div>
            ...
            <div className="flex items-start gap-4 mb-6">
              <div className="shrink-0 w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">3</div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="shrink-0 w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold">4</div>
              <div>
      ...
      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-linear-to-r from-indigo-600 via-purple-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
          <div className="relative">
