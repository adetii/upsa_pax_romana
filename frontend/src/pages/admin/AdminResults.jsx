          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {topPerformers.map((result, index) => (
                <div key={index} className="text-center p-4 bg-linear-to-br from-blue-50 to-purple-50 rounded-lg border border-blue-100">
                  <div className="w-8 h-8 bg-linear-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-2">
